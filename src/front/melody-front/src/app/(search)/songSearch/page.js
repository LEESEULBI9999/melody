...
class SongManager extends Component {
    ...
    loadSongs = () => {
        axios.get('/api/song') // Replace with your API endpoint
            .then((response) => {
    ...
    handleAddSong = () => {
        axios.post('/api/song', this.state.newSong) // Replace with your API endpoint
            .then(() => {
                this.loadSongs();
                this.setState({
                    newSong: {
    ...
    handleSearch = () => {
        ...
        axios.get(`/api/song/search?title=${searchKeyword}`) // Replace with your API endpoint
            .then((response) => {
