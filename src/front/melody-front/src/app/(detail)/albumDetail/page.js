...
// import LikeButton from "../../../app/(detail)/albumDetail/likeButton";
                                        ...
                                        {songs
                                            ...
                                            .map((song, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="num"></td>
                                                    <td className="song">
                                                        {/*<Link href={`/app/[songId]/${song.songId}`}>{song.title}</Link>*/}
                                                        <Link href="/song/[songId]" as={`/song/${song.songId}`}>
                                                            {song.title}
                                                        </Link>
                                                    </td>
                                                    <td className="artist">
                                                      <span>
                                                        {song.artistType === "Solo" ? (
                                                            <a href={`/artists/${song.soloArtist.artistId}`}>{song.soloArtist.singerName}</a>
                                                        ) : (
                                                            <a href={`/artists/${song.groupArtist.artistId}`}>{song.groupArtist.groupName}</a>
                                                        )}
                                                      </span>
                                                    </td>
                                                    <td></td>
